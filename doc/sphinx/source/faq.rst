...
.. If you want to **discuss or ask questions on Patro**, you can subscribe and post messages on the
.. **Patro User** mailing list.
.. 
.. There is actually three lists running on Google Groups (*):
.. 
.. `User List <https://groups.google.com/forum/#!forum/Patro-user>`_
..   List for Patro users
.. `Announce List <https://groups.google.com/forum/#!forum/Patro-announce>`_
